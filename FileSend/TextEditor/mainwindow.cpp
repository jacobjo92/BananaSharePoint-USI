...
const QEvent::Type MainWindow::EventRequestStartLoginProcess =
...
{
//     authenticator_1 = new Authenticator();
    m_authenticator = new Authenticator();
    connect(m_authenticator, &Authenticator::authenticated, this,&MainWindow::onLoggedIn);
...
{
    if (event->type() == EventRequestStartLoginProcess) {
        startLoginProcess();
        return true;
    }
...
void MainWindow::showEvent(QShowEvent* event)
{
    if (m_firstTimeShow) {
        ...
        QApplication::postEvent(this, new QEvent(EventRequestStartLoginProcess), Qt::LowEventPriority);
    }
